...
resultsPath='./results/ssd_rbg_i3d_flow_2d_'+OF
resultsPath_merge='./results/merge_ssd_rbg_i3d_flow_2d_'+OF
...
weights_flow_path = './weights/ssd/vgg-16_ssd-fcn_ILSVRC-CLS-LOC.h5'
