...
num_frame=10
resultsPath='./results/ssd_rbg_i3d_flow_i3d_'+OF
resultsPath_merge='./results/merge_ssd_rbg_i3d_flow_i3d_'+OF

model_rgb, predictor_sizes_rgb = ssd_300(input_shape=(num_frame,img_height, img_width, img_channels),
                n_classes=n_classes,
				mode='training',
...
model_flow, predictor_sizes_flow = ssd_300(input_shape=(num_frame,img_height, img_width, img_channels),
                n_classes=n_classes,
				mode='training',
                l2_regularization=0.00004,#0.0005,
                scales=scales,
