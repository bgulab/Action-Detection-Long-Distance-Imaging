...
if load_prev_model==1:
    ...
    if input_type == 'liteflow':
        ...
        model.load_weights('./weights/ssd/FFssd300_liteflow_final.h5', by_name=True)
    elif input_type == 'RGB':
        model.load_weights('./weights/ssd/FFssd300_final.h5', by_name=True)
    elif input_type == 'TVL1':
        model.load_weights('./weights/ssd/FFssd300_Tvl1_final.h5', by_name=True)
...
csv_logger = CSVLogger(filename='FFssd300_pascal_07+12_training_log_'+input_type+'.csv',
                       separator=',',
                       append=True)
...
if load_prev_model==0:
    ...
    model_name = './weights/ssd/my_FFssd300_'+input_type+'final'
